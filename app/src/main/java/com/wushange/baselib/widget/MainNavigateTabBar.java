package com.wushange.baselib.widget;
...
public class MainNavigateTabBar extends LinearLayout implements View.OnClickListener {
    ...
    private OnTabDoubleClickListener mOnDoubleClickListener;
...
//            ThemeUtils.checkAppCompatTheme(context);
    ...
    public void onClick(View v) {
        ...
        if (object != null && object instanceof ViewHolder) {
            ...
            tempMap.put(holder.tabIndex, SystemClock.uptimeMillis());
            counts.add(tempMap);
            if (counts.size() == 2) {
                if (counts.get(1).keySet().equals(counts.get(0).keySet()) &&
                    ...
                    if (mOnDoubleClickListener != null) {
                        mOnDoubleClickListener.onDoubleClick(holder);
                    }
                    counts.clear();
                } else {
                    counts.remove(0);
    ...
    public interface OnTabDoubleClickListener {
        void onDoubleClick(ViewHolder holder);
    }
    ...
    public void setTabOnDoubleClickListener(OnTabDoubleClickListener doubleClickListener) {
        mOnDoubleClickListener = doubleClickListener;
    }
